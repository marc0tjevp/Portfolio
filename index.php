...
<body>
    ...
    <div id="top" class="scrollspy parallax-container z-depth-2">
        ...
        <div class="col l12 center parallax-offset"> <a href="https://www.linkedin.com/in/marc0tjevp" target="_blank" class="btn-floating btn-large waves-effect waves white"><i class="fa fa-linkedin"></i></a> <a href="#contact" class="btn-floating btn-large waves-effect waves white"><i class="fa fa-envelope-o"></i></a> <a href="docs/cv.pdf" target="_blank" class="btn-floating btn-large waves-effect waves white"><i class="fa fa-file-text-o"></i></a> <a href="https://github.com/marc0tjevp" target="_blank" class="btn-floating btn-large waves-effect waves white"><i class="fa fa-github"></i></a> </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col l6 m6 s12 center">
                    ...
                    <p>
						Mijn naam is Marco van Poortvliet. Ik ben student Applicatie- &amp; Mediaontwikkeling die niet van stilzitten houdt. 
